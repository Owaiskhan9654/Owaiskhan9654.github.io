...
export function Aurora() {
  return (
    <div aria-hidden className="pointer-events-none fixed inset-0 -z-20 overflow-hidden">
      ...
      <div className="animate-aurora-a absolute -top-1/4 -left-1/4 h-[70vmax] w-[70vmax] rounded-full bg-[radial-gradient(circle_at_center,rgba(124,108,255,0.35),transparent_60%)] blur-3xl dark:bg-[radial-gradient(circle_at_center,rgba(124,108,255,0.28),transparent_60%)]" />
      <div className="animate-aurora-b absolute -right-1/4 top-1/3 h-[60vmax] w-[60vmax] rounded-full bg-[radial-gradient(circle_at_center,rgba(34,211,238,0.28),transparent_60%)] blur-3xl dark:bg-[radial-gradient(circle_at_center,rgba(34,211,238,0.22),transparent_60%)]" />
      <div className="animate-aurora-c absolute bottom-0 left-1/4 h-[55vmax] w-[55vmax] rounded-full bg-[radial-gradient(circle_at_center,rgba(236,72,153,0.20),transparent_60%)] blur-3xl dark:bg-[radial-gradient(circle_at_center,rgba(168,85,247,0.20),transparent_60%)]" />
